...
struct ATutorial_Alpha_GameMode_C_CharacterSpawned_Params
{
public:
...
struct ATutorial_Alpha_GameMode_C_ExecuteUbergraph_Tutorial_Alpha_GameMode_Params
{
public:
	...
	class APawn*                                 K2Node_Event_Character;                            // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AAlpha_PlayerController_C*             K2Node_Event_Controller;                           // 0x28(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AAlpha_PlayerController_C*             CallFunc_Array_Get_Item;                           // 0x40(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
