...
public:
	...
	static class ABP_PickupAntiCannon_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void S_Activate();
	void Activate(class ABP_Character_C* LocalCharacterRef);
	void ExecuteUbergraph_BP_PickupAntiCannon(int32 EntryPoint, class ABP_Character_C* K2Node_Event_LocalCharacterRef);
};
