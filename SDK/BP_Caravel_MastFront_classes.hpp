...
class ABP_Caravel_MastFront_C : public ABP_Brig_MastBase_C
{
public:
	...
	static class ABP_Caravel_MastFront_C* GetDefaultObj();

	void ReceiveTick(float DeltaSeconds);
	void ExecuteUbergraph_BP_Caravel_MastFront(int32 EntryPoint, float CallFunc_MapRangeClamped_ReturnValue, float K2Node_Event_DeltaSeconds, const struct FVector& CallFunc_MakeVector_ReturnValue);
};
