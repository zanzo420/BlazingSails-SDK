...
class UUI_TreasureFoundPopUp_Golden_C : public UUI_TopScreenMessageBase_C
{
public:
	...
	static class UUI_TreasureFoundPopUp_Golden_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_UI_TreasureFoundPopUp_Golden(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1);
};
