...
{
public:
	uint8                                        Pad_208E[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2090[0x25];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2097[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_209C[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_209F[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_1DE : 1;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_20A1[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
