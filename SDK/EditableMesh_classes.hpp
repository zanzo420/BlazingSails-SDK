...
public:
	...
	uint8                                        Pad_1841[0x9C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_187D[0x390];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_187F[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1880[0x1E4];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1882[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
