...
{
public:
	uint8                                        Pad_39[0x10];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_44[0x40];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_46[0xF];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	class UVaRestJsonObject*                     RequestJsonObj;                                    // 0xB0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_47[0x30];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class UVaRestJsonObject*                     ResponseJsonObj;                                   // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UVaRestJsonValue*                      ResponseJsonValue;                                 // 0xF0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_48[0xD0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_49[0x6];                                       // Fixing Size Of Struct [ Dumper-7 ]
