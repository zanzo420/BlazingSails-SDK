...
class UClass* ABP_ExplosiveBarrel_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_ExplosiveBarrel_C");

	return Clss;
}


// BP_ExplosiveBarrel_C BP_ExplosiveBarrel.Default__BP_ExplosiveBarrel_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_ExplosiveBarrel_C* ABP_ExplosiveBarrel_C::GetDefaultObj()
{
	static class ABP_ExplosiveBarrel_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_ExplosiveBarrel_C*>(ABP_ExplosiveBarrel_C::StaticClass()->DefaultObject);
...
void ABP_ExplosiveBarrel_C::UserConstructionScript(const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_ExplosiveBarrel_C", "UserConstructionScript");

	Params::ABP_ExplosiveBarrel_C_UserConstructionScript_Params Parms{};
...
void ABP_ExplosiveBarrel_C::ReceiveBeginPlay()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ExplosiveBarrel_C", "ReceiveBeginPlay");
...
void ABP_ExplosiveBarrel_C::ReceiveTick(float DeltaSeconds)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ExplosiveBarrel_C", "ReceiveTick");

	Params::ABP_ExplosiveBarrel_C_ReceiveTick_Params Parms{};
...
// Parameters:
// float                              DelayedFuse                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_ExplosiveBarrel_C::Explode(float DelayedFuse, class ABP_Controller_C* ControllerRef)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ExplosiveBarrel_C", "Explode");

	Params::ABP_ExplosiveBarrel_C_Explode_Params Parms{};

	Parms.DelayedFuse = DelayedFuse;
...
void ABP_ExplosiveBarrel_C::MC_Effects()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ExplosiveBarrel_C", "MC_Effects");
...
void ABP_ExplosiveBarrel_C::S_Explode(class ABP_Controller_C* ControllerRef, float DelayedFuse)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ExplosiveBarrel_C", "S_Explode");

	Params::ABP_ExplosiveBarrel_C_S_Explode_Params Parms{};
...
// float                              K2Node_CustomEvent_DelayedFuse_1                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ABP_Controller_C*            K2Node_CustomEvent_ControllerRef_1                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// float                              K2Node_CustomEvent_DelayedFuse                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_ExplosiveBarrel_C::ExecuteUbergraph_BP_ExplosiveBarrel(int32 EntryPoint, TArray<class AActor*>& Temp_object_Variable, bool Temp_bool_Has_Been_Initd_Variable, bool CallFunc_HasAuthority_ReturnValue, float K2Node_Event_DeltaSeconds, TArray<class AWaterSettings_C*>& CallFunc_GetAllActorsOfClass_OutActors, class AWaterSettings_C* CallFunc_Array_Get_Item, bool CallFunc_IsValid_ReturnValue, float K2Node_CustomEvent_DelayedFuse_1, class ABP_Controller_C* K2Node_CustomEvent_ControllerRef_1, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FTransform& CallFunc_Conv_VectorToTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_1, class ABP_AOEHugeExplosion_C* CallFunc_FinishSpawningActor_ReturnValue, const struct FVector& CallFunc_VInterpTo_ReturnValue, const struct FHitResult& CallFunc_K2_SetActorLocation_SweepHitResult, bool CallFunc_K2_SetActorLocation_ReturnValue, const struct FVector2D& CallFunc_Add_Vector2DVector2D_ReturnValue, float CallFunc_BreakVector_X_1, float CallFunc_BreakVector_Y_1, float CallFunc_BreakVector_Z_1, float CallFunc_BreakVector_X_2, float CallFunc_BreakVector_Y_2, float CallFunc_BreakVector_Z_2, const struct FVector& CallFunc_MakeVector_ReturnValue, float CallFunc_GetWaterHeight_WaterHeight, const struct FVector& CallFunc_CalculateDeltaOnly_Delta, float CallFunc_RandomFloatInRange_ReturnValue, float CallFunc_BreakVector_X_3, float CallFunc_BreakVector_Y_3, float CallFunc_BreakVector_Z_3, const struct FVector& CallFunc_MakeVector_ReturnValue_1, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue_1, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue_1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_2, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue, class ABP_Controller_C* K2Node_CustomEvent_ControllerRef, float K2Node_CustomEvent_DelayedFuse, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_3, const struct FHitResult& CallFunc_SphereTraceSingle_OutHit, bool CallFunc_SphereTraceSingle_ReturnValue, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_ElementIndex, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class ABP_BoatMeshBase_C* K2Node_DynamicCast_AsBP_Boat_Mesh_Base, bool K2Node_DynamicCast_bSuccess, class ABP_GameState_C* K2Node_DynamicCast_AsBP_Game_State, bool K2Node_DynamicCast_bSuccess_1, bool Temp_bool_IsClosed_Variable)
{
	...
	Parms.K2Node_CustomEvent_DelayedFuse_1 = K2Node_CustomEvent_DelayedFuse_1;
	Parms.K2Node_CustomEvent_ControllerRef_1 = K2Node_CustomEvent_ControllerRef_1;
	...
	Parms.K2Node_CustomEvent_DelayedFuse = K2Node_CustomEvent_DelayedFuse;
