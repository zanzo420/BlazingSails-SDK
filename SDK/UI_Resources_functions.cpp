...
class UClass* UUI_Resources_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Resources_C");

	return Clss;
}


// UI_Resources_C UI_Resources.Default__UI_Resources_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Resources_C* UUI_Resources_C::GetDefaultObj()
{
	static class UUI_Resources_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Resources_C*>(UUI_Resources_C::StaticClass()->DefaultObject);
...
void UUI_Resources_C::RefreshResources()
{
	...
	if (!Func)
		Func = Class->GetFunction("UI_Resources_C", "RefreshResources");
