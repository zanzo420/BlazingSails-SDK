...
class UClass* ABP_ActionItems_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_ActionItems_C");

	return Clss;
}


// BP_ActionItems_C BP_ActionItems.Default__BP_ActionItems_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_ActionItems_C* ABP_ActionItems_C::GetDefaultObj()
{
	static class ABP_ActionItems_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_ActionItems_C*>(ABP_ActionItems_C::StaticClass()->DefaultObject);
...
void ABP_ActionItems_C::StartAction()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ActionItems_C", "StartAction");
