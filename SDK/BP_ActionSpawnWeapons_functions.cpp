...
class UClass* ABP_ActionSpawnWeapons_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_ActionSpawnWeapons_C");

	return Clss;
}


// BP_ActionSpawnWeapons_C BP_ActionSpawnWeapons.Default__BP_ActionSpawnWeapons_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_ActionSpawnWeapons_C* ABP_ActionSpawnWeapons_C::GetDefaultObj()
{
	static class ABP_ActionSpawnWeapons_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_ActionSpawnWeapons_C*>(ABP_ActionSpawnWeapons_C::StaticClass()->DefaultObject);
...
void ABP_ActionSpawnWeapons_C::StartAction()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ActionSpawnWeapons_C", "StartAction");
...
// class ABP_AllWeapons_C*            CallFunc_FinishSpawningActor_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
