...
{
public:
	uint8                                        Pad_1C84[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_1AB : 2;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_1C89[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C8B[0x24];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C8D[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C8E[0x798];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C8F[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C95[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
