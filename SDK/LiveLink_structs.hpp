...
public:
	...
	uint8                                        Pad_1C60[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FAnimNode_LiveLinkPose                PoseNode;                                          // 0x770(0x50)(Edit, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_1C61[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C62[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
