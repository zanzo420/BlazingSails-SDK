...
{
public:
	uint8                                        Pad_2175[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2176[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2178[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
