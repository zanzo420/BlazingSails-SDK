...
class ABP_WeaponFishPistol_C : public ABP_WeaponRangedBase_C
{
public:
	...
	static class ABP_WeaponFishPistol_C* GetDefaultObj();

	void ReloadEvent(class ABP_Character_C* CharacterRef);
	void HolsteredEvent();
	void ExecuteUbergraph_BP_WeaponFishPistol(int32 EntryPoint, class ABP_Character_C* K2Node_Event_CharacterRef, bool CallFunc_K2_AttachToComponent_ReturnValue, const struct FHitResult& CallFunc_K2_SetRelativeLocation_SweepHitResult);
};
