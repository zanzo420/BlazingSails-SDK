...
class UUI_TreasureFoundPopUp_Base_C : public UUI_TopScreenMessageBase_C
{
public:
	...
	static class UUI_TreasureFoundPopUp_Base_C* GetDefaultObj();

	class FText GetText_0(const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue);
	void Construct();
	void ExecuteUbergraph_UI_TreasureFoundPopUp_Base(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1);
};
