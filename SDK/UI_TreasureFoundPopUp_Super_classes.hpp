...
class UUI_TreasureFoundPopUp_Super_C : public UUI_TopScreenMessageBase_C
{
public:
	...
	static class UUI_TreasureFoundPopUp_Super_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_UI_TreasureFoundPopUp_Super(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1);
};
