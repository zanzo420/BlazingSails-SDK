...
struct ABP_WeaponFireBow_C_LoadedState_Params
{
public:
...
struct ABP_WeaponFireBow_C_ExecuteUbergraph_BP_WeaponFireBow_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_Loaded;                               // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
