...
struct UUI_ChatMessage_C_FormatChatMessageText_Params
{
public:
...
public:
	...
	class UVerticalBoxSlot*                      K2Node_DynamicCast_AsVertical_Box_Slot;            // 0x10(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  K2Node_CustomEvent_Message;                        // 0x50(0x18)(None)
	...
	int32                                        CallFunc_Len_ReturnValue_1;                        // 0x7C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                CallFunc_RightChop_ReturnValue;                    // 0x88(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_FindSubstring_ReturnValue_1;              // 0xAC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                CallFunc_RightChop_ReturnValue_1;                  // 0xB8(0x10)(ZeroConstructor, HasGetValueTypeHash)
	int32                                        CallFunc_Len_ReturnValue_2;                        // 0xC8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3623[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_Trim_ReturnValue;                         // 0xD0(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                CallFunc_LeftChop_ReturnValue_1;                   // 0xF8(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_Trim_ReturnValue_1;                       // 0x108(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_SelectString_ReturnValue_1;               // 0x118(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue;            // 0x128(0x18)(None)
	class FString                                CallFunc_TrimTrailing_ReturnValue;                 // 0x140(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_1;          // 0x150(0x18)(None)
	int32                                        CallFunc_Len_ReturnValue_3;                        // 0x168(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
