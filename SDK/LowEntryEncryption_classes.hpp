...
public:
	...
	uint8                                        Pad_29E[0x24];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	bool                                         DecryptionWSet;                                    // 0x40(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2A9[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C9[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2CA[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
