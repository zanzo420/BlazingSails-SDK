...
class UClass* ABP_BoatMeshBrigantine_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BoatMeshBrigantine_C");

	return Clss;
}


// BP_BoatMeshBrigantine_C BP_BoatMeshBrigantine.Default__BP_BoatMeshBrigantine_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_BoatMeshBrigantine_C* ABP_BoatMeshBrigantine_C::GetDefaultObj()
{
	static class ABP_BoatMeshBrigantine_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_BoatMeshBrigantine_C*>(ABP_BoatMeshBrigantine_C::StaticClass()->DefaultObject);
...
void ABP_BoatMeshBrigantine_C::ReceiveBeginPlay()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_BoatMeshBrigantine_C", "ReceiveBeginPlay");
...
void ABP_BoatMeshBrigantine_C::ReceiveTick(float DeltaSeconds)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_BoatMeshBrigantine_C", "ReceiveTick");

	Params::ABP_BoatMeshBrigantine_C_ReceiveTick_Params Parms{};
...
void ABP_BoatMeshBrigantine_C::Refresh()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_BoatMeshBrigantine_C", "Refresh");
