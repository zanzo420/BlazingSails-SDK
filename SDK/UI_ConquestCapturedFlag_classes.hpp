...
class UUI_ConquestCapturedFlag_C : public UUserWidget
{
public:
	...
	static class UUI_ConquestCapturedFlag_C* GetDefaultObj();

	struct FLinearColor GetColorAndOpacity_0();
	void Construct();
	void ExecuteUbergraph_UI_ConquestCapturedFlag(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
