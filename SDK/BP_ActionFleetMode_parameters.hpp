...
struct ABP_ActionFleetMode_C_ExecuteUbergraph_BP_ActionFleetMode_Params
{
public:
	...
	uint8                                        Pad_2087[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class ABP_ActionChangeMaxPreGame_C*          CallFunc_FinishSpawningActor_ReturnValue;          // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
