...
class ABP_ProjectilePathSphere_C : public AActor
{
public:
	...
	static class ABP_ProjectilePathSphere_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_ProjectilePathSphere(int32 EntryPoint);
};
