...
public:
	...
	uint8                                        Pad_63[0x20];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_64[0x28];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_65[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9B[0x140];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9C[0x18];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9D[0x88];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9E[0x38];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9F[0x68];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_AC[0x110];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_AD[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
